    ...
    <div class="buyer-profile-cover bg-image mb-4" data-image="/assets/images/profile-bg.jpg">
        <div
            ...
            <div class="avatar avatar-xl me-3">
                <img src="{{ auth()->user()->profile_photo_url }}" class="rounded-circle" alt="...">
            </div>
                ...
                <div class="col-md-4">
                    <div class="card bg-cyan text-white-90">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div>
                                <div class="mb-0">{{ $order_count }}</div>
                                <span>My Orders</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card bg-teal text-white-90">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div>
                                <div class="mb-0">${{ $total_expenses ?? 0 }}</div>
